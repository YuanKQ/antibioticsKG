                ...
                <div class="row">
                    <div class="col-md-offset-1 col-md-10">
                        <div class="container" align="center">
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    <p class="lead" align="left"> <font face="Times New Roman"> We present a system for node-linkbased medical knowledge graph (KG) visualization, allowing visual inspection of knowledge subgraph based on probabilistic graph layout. Specifically, we reuse existing knowledge bases to alleviate the difficulties in building a high-quality knowledge graph, ranging in size up to 7 million edges. Then we provide insights into probability distributions for the subgraph consisted of individual nodes and edges. The visualization is created by transforming probability distributions into a two-dimensional embedding using graph layout techniques. Splatting and edge bundling are used to visualize point clouds and graph topology.</font>
                                    </p>
                                    <p class="lead" align="left"> <font face="Times New Roman">In IASO, <b>Graph Module</b> demonstrates the detailed information of the input entity including its KG subgraph, the connected entities and their corresponding relationships. <b>Contents Index Module</b> presents the complete hierarchy taxonomy of the KG to make the inheritance relationship more understandable. The labeled datasets about the antibiotic drug similarity measure can be downloaded from  <a href="dataDownload#dataSet"><b>Data Download Module</b></a>. <b>The RESTful API</b> allows users to obtain the query results in json format.</font>
                                    </p>
                                    <p class="lead" align="left"> <font face="Times New Roman"><b>Paper for introducing IASO system:</b></b></font>
                                    </p>
                                    <p class="lead" align="left"> <font face="Times New Roman">Shen Y, Yuan K, Dai J, Tang B, Yang M, Lei K. KGDDS: A System for Drug-Drug Similarity Measure in Therapeutic Substitution based on Knowledge Graph Curation. <b>Journal of Medical Systems</b>, 2019. (SCI, IF: 2.098)</font>
                                    </p>
...
<#--此处应插入图片-->
                        ...
                        <hr>
                        <ol>
                            <li><p>Shen Y, Colloc J, Jacquet-Andrieu A, Lei K. Emerging Medical Informatics with Case-Based Reasoning for Aiding Clinical Decision in Multi-Agent System.
                                <b><i>Journal of Biomedical Informatics</b></i>, 2015, 56: 307–317. (JCR 1, IF: 2.882)</p></li>
                            <li><p>Shen Y, Yuan K, Chen D, Colloc J, Yang M, Li Y, Lei K. An ontology-driven clinical decision support system (IDDAP) for infectious disease diagnosis and antibiotic prescription.
                            ...
                            <li><p>Shen Y, Zhang L, Zhang J, Yang M, Tang B, Li Y, Lei K. CBN: Constructing a Clinical Bayesian Network based on Data from the Electronic Medical Record.
                                <b><i>Journal of Biomedical Informatics </b></i>,2018, 88: 1–10. (JCR 1, IF: 2.882)</p></li>
                            <li><p>Shen Y, Chen D, Tang B, Yang M, Lei K. EAPB: Entropy-Aware Path-Based Metric for Ontology Quality.
                                <b><i>Journal of Biomedical Semantics </b></i>, 2018, 9(1), 20. (JCR 2, IF: 1.883)</p></li>
                            <li><p>Shen Y, Yuan K, Dai J, Tang B, Yang M, Lei K. KGDDS: A System for Drug-Drug Similarity Measure in Therapeutic Substitution based on Knowledge Graph Curation.
                                <b><i>Journal of Medical Systems </b></i> ,2019. (JCR 4, IF: 2.098)</p></li>
                            <li><p>Shen Y, Li Y, Huang J, Zhang J, Si S, Yang M, Lei K. Discovering Medical Entity Relations from Texts using Dependency Information.
                                <b><i>Natural Language Engineering </b></i>, 2018, 1–21. Cambridge University Press. (JCR 4, IF: 0.8)</p></li>
                            <li><p>Lei K, Liu Y, Zhong S, Liu Y, Xu K, Shen Y, Yang M. Understanding User Behavior in Sina Weibo Online Social Network: A Community Approach.
                                <b><i>IEEE Access. </b></i>, 6(2018), 13302-13316. (JCR 1, IF: 3.557)</p></li>
                            <li><p>Lei K, Zhang LZ, Liu Y, Shen Y, Liu CW. An event summarizing algorithm based on the timeline relevance model in Sina Weibo.
                                <b><i>IScience China Information Sciences </b></i>(SCIS), 61(12), 129101. (JCR 1, IF: 2.188)</p></li>
                            <li><p>Shen Y, Chen D, Yang M, Li Y, Du N, Lei K. Ontology Evaluation with Path-based Text-aware Entropy Computation. In The 41st International ACM SIGIR Conference on Research & Development in Information Retrieval
                                <b><i>(SIGIR 2018). </b></i>SIGIR: Ann Arbor, Michigan, USA, July 8-12. pp. 881-884. ACM. (CCF A)</p></li>
                            <li><p>Shen Y, Deng Y, Yang M, Li Y, Du N, Fan W, Lei K. Knowledge-aware Attentive Neural Network for Ranking Question Answer Pairs. In The 41st International ACM SIGIR Conference on Research & Development in Information Retrieval
                                <b><i>(SIGIR 2018). </b></i>SIGIR: Ann Arbor, Michigan, USA, July 8-12. pp. 901-904. ACM. (CCF A)</p></li>
                            <li><p>Deng Y, Xie Yu, Li Y, Yang M, Du N, Fan W, Lei K, Shen Y. Multi-Task Learning with Multi-View Attention for Answer Selection and Knowledge Base Question Answering. In The Thirty-Third AAAI Conference on Artificial Intelligence
                                <b><i>(AAAI-19). </b></i>Honolulu, Hawaii, USA, January 27 – February 1, 2019. ACM (CCF A)</p></li>
                            <li><p>Shen Y, Deng Y, Zhang J, Li Y, Du N, Fan W, Lei K. IDDAT: An Ontology-Driven Decision Support System for Infectious Disease Diagnosis and Therapy. In The 18th IEEE International Conference on Data Mining
                                <b><i>(ICDM 2018）. </b></i>Singapore, November 17-20, 2018. (CCF B)</p></li>
                            <li><p>Shen Y, Yuan K, Li Y, Tang B, Yang M, Du N, Lei K. Drug2Vec: Knowledge-aware Feature-driven Method for Drug Representation Learning. In The IEEE International Conference on Bioinformatics and Biomedicine
                                <b><i> (BIBM 2018). </b></i>Madrid, Spain, December 3-6 2018. (CCF B)</p></li>
                            <li><p>Deng Y, Shen Y, Yang M, Li Y, Du N, Fan W, Lei K. Knowledge as A Bridge: Improving Cross-domain Answer Selection with External Knowledge. In The 27th International Conference on Computational Linguistics
                                <b><i>(COLING 2018). </b></i>Santa Fe, New-Mexico, USA, August 20-26, 2018. pp. 3295-3305. (CCF B)</p></li>
                            <li><p>Lei K, Chen D, Li Y, Yang M, Du N, Fan W, Shen Y. Cooperative Denoising for Distantly Supervised Relation Extraction. In The 27th International Conference on Computational Linguistics
                                <b><i>(COLING 2018). </b></i>Santa Fe, New-Mexico, USA, August 20-26, 2018. pp. 426-436. (CCF B)</p></li>
                            <li><p>Lei K, Yuan K, Zhang Q, Shen Y. MedSim: A Novel Semantic Similarity Measure in Bio-medical Knowledge Graphs. In The 11th International Conference on Knowledge Science, Engineering and Management
                                <b><i> (KSEM 2018). </b></i>Changchun, China, August 17-19, 2018. pp. 479-490. (CCF C)</p></li>
                            <li><p>Lei K, Huang J, Si S, Shen Y. Semantic Similarity Measures to Disambiguate Terms in Medical Text. In The 25th International Conference on Neural Information Processing
                                <b><i> (ICONIP2018). </b></i>Siem Reap, Cambodia, December 13-16, 2018. pp. 398-409. (CCF C)</p></li>
                            <li><p>Shen Y, Zhang Q, Zhang J, Huang J, Lu Y, Lei K. Improving Medical Short Text Classification with Semantic Expansion using Word-Cluster Embedding. In The 9th iCatse Conference on Information Science and Applications
                                <b><i> (ICISA2018). </b></i>Hong Kong, June 25-27, 2018. pp. 401-412.</p></li>
                            <li><p>Colloc J, Yameogo R, Summons P, Shen Y, Park M, Aronson J E. EPICE an Emotion Fuzzy Vectorial Space for Time Modeling in Medical Decision, In The International Conference on Internet of Things and Machine Learning
                        ...
                        <hr>
                        <ol>
                            <li><p>2016-2018: Research on Key Technologies of Knowledge Reasoning in Medical Diagnosis and Treatment, National Natural Science Foundation of China Youth Science Foundation.
                            </p></li>
                            <li><p>2016-2019: Research on methods and techniques of knowledge mapping for general practice decision-making, Shenzhen Key Basic Research Project.</p></li>
                        </ol>
                    </div>
                </div>
            </div>
